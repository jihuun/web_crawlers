...
if __name__  == "__main__":
	...
	f.write("\n총 %d 개  \n\n" %(book_cnt))
	f.write("> The list has been generated by a python %s which is open source project.  \n" %(md_make_hyperlink("script", "https://github.com/jihuun/web_crawlers/blob/master/trevari/get_trevari_books.py")))
	f.write("> Sharing this list, reporting bugs & ideas, %s are always welcom :)  \n" %(md_make_hyperlink("pull requests", "https://github.com/jihuun/web_crawlers")))
